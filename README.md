...
5. `export-po` generates translator-friendly PO output you can hand off or version.

## Essential CLI Commands

| Command | When to use | Example |
|---------|-------------|---------|
| `rimloc-cli scan` | Inventory strings from mod XML into CSV or JSON. | `rimloc-cli scan --root ./path/to/mod --format json` |
...
| `rimloc-cli export-po` | Generate PO or CSV hand-off packages. | `rimloc-cli export-po --out ./out --single-po` |
| `rimloc-cli import-po` | Bring PO updates back into XML. | `rimloc-cli import-po --po ./out/mymod.po --out ./Languages` |
