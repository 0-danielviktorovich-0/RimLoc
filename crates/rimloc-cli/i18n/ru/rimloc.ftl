...
help-buildmod-from-game-version = При --from-root учитывать только файлы внутри указанной подпапки версии
...
# morph
help-morph-about = Сгенерировать файлы Case/Plural/Gender с помощью провайдера морфологии (dummy/morpher)
help-morph-root = Путь к корню мода RimWorld
help-morph-provider = Провайдер: dummy (по умолчанию) или morpher
